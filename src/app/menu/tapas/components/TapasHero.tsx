...
const TapasHeroSection = () => {
  const scrollToMenu = () => {
    const menuSection = document.getElementById('tapas-menu');
    if (menuSection) {
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src="/tapas.jpg" // Replace with your tapas hero image
          alt="Tapas et entrées raffinées"
          fill
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        >
          ...
          >
            <span className="block">Tapas</span>
          ...
          >
            Découvrez nos créations savoureuses qui éveillent les papilles, 
            où chaque bouchée révèle un équilibre parfait de goûts méditerranéens.
...
export default TapasHeroSection;