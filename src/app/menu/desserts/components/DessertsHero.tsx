...
const DessertsHeroSection = () => {
  const scrollToMenu = () => {
    const menuSection = document.getElementById('desserts-menu');
    if (menuSection) {
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src="/desserts.jpg" // Replace with your desserts hero image
          alt="Desserts artisanaux élégants"
          fill
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        >
          ...
          >
            <span className="block">Desserts</span>
          ...
          >
            Savourez nos créations sucrées exceptionnelles, 
            où chaque dessert est une symphonie de saveurs et de textures raffinées.
            <span className="block mt-4 text-amber-300/80 text-base md:text-lg font-extralight italic">
              L'art de la pâtisserie française sublimée
            </span>
          </motion.p>
...
export default DessertsHeroSection;