...
const PoissonViandesHeroSection = () => {
  const scrollToMenu = () => {
    const menuSection = document.getElementById('poisson-viandes-menu');
    if (menuSection) {
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src="/poisson.jpg" // Replace with your fish & meat hero image
          alt="Poissons frais et viandes de qualité, cuisine raffinée"
          fill
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        >
          ...
          >
            <span className="block">Poissons</span>
          ...
          >
            Savourez nos poissons de mer fraîchement pêchés et nos viandes 
            d'exception, cuisinés avec expertise et accompagnés de garnitures raffinées.
            <span className="block mt-4 text-amber-300/80 text-base md:text-lg font-extralight italic">
              La fraîcheur et la qualité à l'honneur
            </span>
          </motion.p>
...
export default PoissonViandesHeroSection;