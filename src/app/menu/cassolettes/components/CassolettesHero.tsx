...
const CassolettesHeroSection = () => {
  const scrollToMenu = () => {
    const menuSection = document.getElementById('cassolettes-menu');
    if (menuSection) {
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src="/cassolettes.jpg" // Replace with your cassolettes hero image
          alt="Cassolettes gourmandes, plats mijotés avec amour"
          fill
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        >
          ...
          >
            ...
            <span className="block">Gourmandes</span>
          </motion.h1>
          ...
          >
            Dégustez nos cassolettes traditionnelles, préparées avec des ingrédients 
            de qualité et mijotées lentement pour révéler toute leur saveur.
            <span className="block mt-4 text-amber-300/80 text-base md:text-lg font-extralight italic">
              La tradition culinaire à son apogée
            </span>
          </motion.p>
...
export default CassolettesHeroSection;