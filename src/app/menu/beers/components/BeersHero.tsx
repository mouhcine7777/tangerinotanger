...
const BeersHeroSection = () => {
  const scrollToMenu = () => {
    const menuSection = document.getElementById('bieres-menu');
    if (menuSection) {
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src="/beer.jpg" // Replace with your beer hero image
          alt="Sélection de bières artisanales et d'exception"
          fill
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        >
          ...
          >
            <span className="block">Bières</span>
          ...
          >
            Explorez notre collection unique de bières artisanales et d'exception, 
            des brasseries locales aux créations internationales les plus prisées.
            <span className="block mt-4 text-amber-300/80 text-base md:text-lg font-extralight italic">
              L'art du brassage à l'honneur
            </span>
          </motion.p>
...
export default BeersHeroSection;