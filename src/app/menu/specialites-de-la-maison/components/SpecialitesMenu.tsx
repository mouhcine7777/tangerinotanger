...
const SpecialitesMenu = () => {
  const [expandedItems, setExpandedItems] = useState<ExpandedItems>({});
  
  const specialites = [
    {
      name: "PAELLA NOIR DE SEPIA, CREVETTES, ET ARTICHAUT",
      price: "350",
      portion: "2 pers",
      description: "Paella traditionnelle à l'encre de seiche avec crevettes et artichauts",
      details: "Riz bomba teinté à l'encre de seiche, garni de crevettes fraîches et d'artichauts tendres"
    },
    {
      name: "PAELLA CREVETTES, CALAMAR, ESPADON, PALOURDES",
      price: "380",
      portion: "2 pers",
      description: "Paella mixte aux fruits de mer et poissons",
      details: "Paella généreuse associant crevettes, calamars, espadon et palourdes sur lit de riz safranné"
    },
    {
      name: "POISSONS ET FRUITS DE MER DU JOUR AU FOUR FAÇON \"TAJINE\"",
      price: "1400",
      prepTime: "30 min de préparation",
      description: "Sélection de poissons et fruits de mer cuits au four selon la tradition du tajine",
      details: "Préparation exceptionnelle de poissons et fruits de mer frais du jour, mijotés aux épices orientales"
    },
    {
      name: "PAELLA FIDEUA",
      price: "380",
      portion: "2 pers",
      prepTime: "25 min de préparation",
      description: "Paella aux vermicelles avec crevettes, calamar, espadon et palourdes",
      details: "Variation traditionnelle catalane de la paella, préparée avec des vermicelles fins et fruits de mer"
    },
    {
      name: "RIZ MOELLEUX AUX CREVETTES ROYALES",
      price: "350",
      portion: "1 pers",
      description: "Riz crémeux aux crevettes royales",
      details: "Riz onctueux préparé avec des crevettes royales, dans un bouillon parfumé"
    },
    {
    ...
    },
    {
      ...
      price: "180",
      description: "Poulpe, crevettes et pommes de terre parfumés à l'ail",
      details: "Mélange savoureux de fruits de mer et pommes de terre, généreusement parfumé à l'ail"
    },
    {
      name: "MERLAN, CREVETTES, ET PALOURDES AUX OIGNONS",
      price: "180",
      description: "Merlan, crevettes et palourdes aux oignons confits",
      details: "Trio harmonieux de poissons et fruits de mer, accompagné d'oignons confits"
    },
    {
      name: "POMMES DE TERRE AUX CREVETTES ET CALAMAR À LA SAUCE TOMATE",
      price: "180",
      description: "Pommes de terre garnies de fruits de mer dans une sauce tomate maison",
      details: "Pommes de terre fondantes garnies de crevettes et calamars, nappées d'une sauce tomate parfumée"
    }
  ];

  const toggleDescription = (index: number): void => {
    const key = `specialite-${index}`;
  ...
  return (
    <div id="specialites-menu" className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
            ...
            {specialites.map((specialite, index) => (
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  ...
                  {specialite.prepTime && (
                    <span className="text-xs text-orange-300 bg-orange-500/10 px-2 py-1 rounded">
                      {specialite.prepTime}
                    </span>
                  )}
                </div>
                ...
                >
                  <span className="mr-1">{expandedItems[`specialite-${index}`] ? 'Moins' : 'Détails'}</span>
                  <svg 
                    ...
                    style={{ 
                      transform: expandedItems[`specialite-${index}`] ? 'rotate(180deg)' : 'rotate(0deg)', 
                ...
                <AnimatePresence>
                  {expandedItems[`specialite-${index}`] && (
                    <motion.div
...
export default SpecialitesMenu;