...
const SpecialitesHeroSection = () => {
  const scrollToMenu = () => {
    const menuSection = document.getElementById('specialites-menu');
    if (menuSection) {
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src="/specialites.jpg" // Replace with your house specialties hero image
          alt="Spécialités de la maison, créations culinaires d'exception"
          fill
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        >
          ...
          >
            <span className="block">Spécialités</span>
          ...
          >
            Savourez nos créations culinaires uniques, élaborées avec passion 
            par notre chef et son équipe selon des recettes exclusives.
...
export default SpecialitesHeroSection;